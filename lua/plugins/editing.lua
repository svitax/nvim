...
return {
  ...
  --   -- },
  --   opts = { keymaps = { cycle_next = "]Q", cycle_previous = "[Q" } },
  ...
  --   keys = {
  --     -- stylua: ignore
  --     { "<leader>sy", function() require("telescope").extensions.yank_history.yank_history({ }) end, desc = "Search yank history" }, -- BUG: <c-k> pastes selected entry. change to scroll up
