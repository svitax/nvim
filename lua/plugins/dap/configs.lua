...
local chrome_debugger = { type = "pwa-chrome", request = "launch", name = "Chrome", webRoot = "${workspaceFolder}" }

local lua_debugger = { { type = "nlua", request = "attach", name = "Attach to running Neovim instance" } }
