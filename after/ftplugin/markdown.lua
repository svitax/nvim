...
if require("zk.util").notebook_root(vim.fn.expand("%:p")) ~= nil then
  ...
  vim.keymap.set(
    ...
    { buffer = true, noremap = true, silent = false, desc = "New note (cwd)" }
  )
  ...
  vim.keymap.set(
    ...
    { buffer = true, noremap = true, silent = false, desc = "New note (cwd) with selection as title" }
  )
  ...
  vim.keymap.set(
    ...
    { buffer = true, noremap = true, silent = false, desc = "New note (cwd) with selection as content" }
  )
else
